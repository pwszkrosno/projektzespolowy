...
try{ 
     ...
     try{
        ...
        //   ResultSet rs = stmt.executeQuery("select * from historia_serwisow");
         ResultSet rs = stmt.executeQuery( "select * from historia_serwisow inner join serwisy ON historia_serwisow.id_serwisu=serwisy.id_serwisu inner join samochody ON historia_serwisow.id_samochodu=samochody.id where historia_serwisow.data_poczatek between '"+rok+"-"+miesiac+"-01 ' and '"+rok+"-"+miesiac+"-31 ' ");
